...
lines.push(` */`)
lines.push(``)
lines.push(`export interface Work {`)
lines.push(`  kind: 'image'`)
lines.push(`  /** Key into the generated image manifest. */`)
lines.push(`  image: string`)
lines.push(`  /** Thumbnail height in px at desktop, as the original set it. */`)
lines.push(`  displayHeight: number`)
lines.push(`  title: string`)
lines.push(`  medium?: string`)
lines.push(`  dimensions?: string`)
lines.push(`  year?: number`)
lines.push(`  /** Trailing remark from the original caption, e.g. "met details". */`)
lines.push(`  note?: string`)
lines.push(`}`)
lines.push(``)
lines.push(`export interface WorkVideo {`)
lines.push(`  kind: 'video'`)
lines.push(`  /** Key into the generated media manifest. */`)
lines.push(`  src: string`)
lines.push(`}`)
lines.push(``)
lines.push(`export interface Group {`)
lines.push(`  /** Sub-heading inside a series, e.g. "works on canvas". */`)
lines.push(`  label?: string`)
lines.push(`  works: (Work | WorkVideo)[]`)
lines.push(`}`)
lines.push(``)
lines.push(`export interface Series {`)
...
writeFileSync(new URL("../src/content/works.ts", import.meta.url), lines.join('\n'))
